...
| --- | --- | --- |
| 1 | Identity and user provisioning | [Case study — ready for review; evidence gaps identified](docs/phase-01-identity-and-user-provisioning.md) |
| 2 | Security groups and Microsoft 365 groups | Reserved for a later review |
| 3 | Exchange Online and shared mailboxes | Reserved for a later review |
...
**Current review boundary: Phase 1 only.**
